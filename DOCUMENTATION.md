...
- Uses `CustomA2C` class
- Uses `A2C_CONFIG` (higher LR, no clip range)
- Saves to `models/a2c_highway_final.pt`
...
### `record_video.py`
**What it does:**
1. Loads `ppo_highway_final.pt` using `CustomPPO.load()`
...
Model saved: ./models/ppo_highway_final.pt
...
|------|-------------|---------|
| `models/ppo_highway_final.pt` | train_ppo.py | Final PPO model weights |
| `models/a2c_highway_final.pt` | train_a2c.py | Final A2C model weights |
...
### "FileNotFoundError: models/ppo_highway_final.pt"
